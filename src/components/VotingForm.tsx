...
const VotingForm = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <TabsList className="flex space-x-2 overflow-x-auto no-scrollbar py-2 snap-x snap-mandatory min-w-max pl-2 touch-pan-x">
        
        {/* Films */}
        <TabsTrigger
          value="film"
          data-value="film"
          className="relative flex-shrink-0 px-4 py-2 whitespace-nowrap snap-start"
        >
