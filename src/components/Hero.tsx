...
import { ArrowDownCircle, ArrowRight, Film, TrendingUp, Users, Zap } from "lucide-react";
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 min-h-screen items-center">
          ...
          >
            ...
            <motion.p 
              variants={itemVariants}
              className="mt-8 text-lg md:text-xl text-black/80 dark:text-white/80 max-w-xl"
            >
              MoviePulse helps creators understand audience preferences by collecting and analyzing content preferences worldwide across films, TV shows, YouTube videos, and streaming platforms.
            </motion.p>
            ...
            >
              ...
              >
                <span className="relative z-10 flex items-center gap-2">Explore Features</span>
                <motion.div
                  animate={{ y: [0, 5, 0] }}
                  transition={{ repeat: Infinity, duration: 1.5, repeatType: "reverse" }}
                  className="ml-2"
            ...
            <div className="relative w-full h-[500px] perspective-[1200px]">
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex flex-col justify-end p-8">
                  <span className="text-xs text-white/70 uppercase tracking-wider">Featured</span>
                  <h3 className="text-2xl font-bold text-white mt-1">Audience-Driven Content</h3>
                  <p className="text-white/80 mt-2 max-w-md">Creating entertainment that resonates with what people actually want to see.</p>
                </div>
              </motion.div>
